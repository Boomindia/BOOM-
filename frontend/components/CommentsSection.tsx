...
export default function CommentsSection({ isOpen, onClose, videoId }: CommentsSectionProps) {
  ...
  const commentsContent = (
    <div className="comments-section open fixed bottom-0 left-0 right-0 h-[70vh] bg-background border-radius-[20px_20px_0_0] z-[9999] transform-none">
      {/* Header */}
  ...
  return typeof window !== "undefined" ? createPortal(commentsContent, document.body) : null
}
